...
<html>
    ...
    <body>
      ...
      <?php
      $req = $bdd->query('Select JOUEURS.NOM_JOUEUR, PRENOM_JOUEUR, PSEUDONYME, coalesce(TMP.NB_RARE, 0) as RARE from JOUEURS
      left join
      ...
      while($donnees = $req->fetch()){?>
        ...
        Nombre de cartes rares : <strong><?php echo $donnees['RARE'];?></strong></br></br>
      <?php
      }
