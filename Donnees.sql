...
insert into EXEMPLAIRES values ( 17, '04-APR-04', '05-MAY-05', 'ECHANGE', 100, 'AUCUN', 1, 1 ) ;
insert into EXEMPLAIRES values ( 18, '04-APR-04', '05-MAY-05', 'ECHANGE', 90, 'BRILLANT', 2, 2 ) ;
insert into EXEMPLAIRES values ( 19, '04-APR-04', '05-MAY-05', 'ECHANGE', 80, 'SOMBRE', 3, 3 ) ;
insert into EXEMPLAIRES values ( 20, '01-DEC-19', NULL, 'ACHAT', 90, 'AUCUN', 1, 10 ) ;
insert into EXEMPLAIRES values ( 21, '01-FEB-03', NULL, 'ECHANGE', 90, 'SOMBRE', 2, 11 ) ;
...
-- CARTES
insert into CARTES values (1,'DRAGON BLANC AUX YEUX BLEUS', 'Ce dragon légendaire est un puissant moteur de destruction. Rares sont ceux qui ont survécu à cette terrifiante créature quasiment invincible pour en parler.', 'Monstre normal',NULL,  8);
insert into CARTES values (2,'SOLDAT GALACTIQUE', 'Vous pouvez envoyer 1 autre monstre LUMIÈRE depuis votre main au Cimetière ; Invoquez Spécialement cette carte depuis votre main en Position de Défense. Lorsque cette carte est Invoquée Spécialement : vous pouvez ajouter 1 monstre "Galactique" depuis votre Deck à votre main. Vous ne pouvez utiliser cet effet de "Soldat Galactique" qu une fois par tour.',  'Monstre normal', NULL, 5);
insert into CARTES values (3,'PLANEUR DU KAISER', 'Non destructible au combat avec un monstre qui a la même ATK. Si cette carte est détruite et envoyée au Cimetière : ciblez 1 monstre sur le Terrain ; renvoyez la cible à la main.',  'Monstre normal', NULL, 6);
insert into CARTES values (4,'BOEUF DE COMBAT ENRAGE', 'Si un monstre de Type Bête/Bête-Guerrier/Bête Ailée que vous contrôlez attaque un monstre en Position de Défense, infligez des dommages de combat perçants à votre adversaire.', 'Monstre normal', NULL,  4);
insert into CARTES values (5,'CYBER DRAGON', 'Si uniquement votre adversaire contrôle un monstre, vous pouvez Invoquer Spécialement cette carte (depuis votre main).', 'Monstre normal', NULL,  5);
insert into CARTES values (6,'CYBER DRAGON JUMELE', '"Cyber Dragon" + "Cyber Dragon" L Invocation Fusion de cette carte ne peut être faite qu avec les Matériels Fusion ci-dessus. Cette carte peut faire une seconde attaque durant chaque Battle Phase.', 'Monstre normal', NULL,  8);
insert into CARTES values (7,'DRAGON CYBER ULTIME', '"Cyber Dragon" + "Cyber Dragon" + "Cyber Dragon" L Invocation Fusion de cette carte ne peut être faite qu avec les Matériels Fusion ci-dessus. Si cette carte attaque un monstre en Position de Défense, infligez des dommages de combat perçants.', 'Monstre normal', NULL,  10);
insert into CARTES values (8,'CHAT SAUVETEUR', 'Vous pouvez envoyer cette carte au Cimetière ; Invoquez Spécialement 2 monstres de Type Bête de max. Niveau 3 depuis votre Deck, mais ils ont leurs effets annulés, et aussi, ils sont détruits durant la End Phase. Vous ne pouvez utiliser cet effet de "Chat Sauveteur" qu une fois par tour.', 'Monstre normal', NULL,  4);
insert into CARTES values (9,'LAPIN SAUVETEUR', 'Non Invocable Spécialement depuis le Deck. Vous pouvez bannir cette carte face recto que vous contrôlez ; Invoquez Spécialement 2 Monstres Normaux de max. Niveau 4 de même nom depuis votre Deck, mais détruisez-les durant la End Phase. Vous ne pouvez utiliser cet effet de "Lapin Sauveteur" qu une fois par tour.', 'Monstre normal', NULL,  4);
insert into CARTES values (10,'OJAMA JAUNE', 'Un membre du trio Ojama, qui a la réputation de se mêler de tout et par tous les moyens. Il est dit également que lorsque les trois sont réunis, il se passe toujours quelque chose.', 'Monstre normal', NULL,  2);
insert into CARTES values (11,'OJAMA NOIR', 'Un membre du trio Ojama, qui a la réputation de se mêler de tout et par tous les moyens. Il est dit également que lorsque les trois sont réunis, il se passe toujours quelque chose.', 'Monstre normal', NULL,  2);
