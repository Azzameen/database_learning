...
Create view Meilleur_niveau as (
  Select CARACTERISTIQUES.DESC_CARACTERISTIQUES, T2.NIVEAU_CARTE, T2.TYPE_CARTE, T2.ID_CARTE
  from (CARACTERISTIQUES inner join POSSESSIONS_CARACTERISTIQUES
  on CARACTERISTIQUES.ID_CARACTERISTIQUES = POSSESSIONS_CARACTERISTIQUES.ID_CARACTERISTIQUES)
  inner join
  (Select CARTES.ID_CARTE, CARTES.NIVEAU_CARTE, CARTES.TYPE_CARTE
  from CARTES
  natural join (
