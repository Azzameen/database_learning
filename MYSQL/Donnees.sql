...
insert into POSSESSIONS_EXEMPLAIRES values ( 3, 6 ) ;
...
insert into POSSESSIONS_EXEMPLAIRES values ( 4, 13 ) ;
...
insert into POSSESSIONS_EXEMPLAIRES values ( 6, 19 ) ;
insert into POSSESSIONS_EXEMPLAIRES values ( 6, 20 ) ;
